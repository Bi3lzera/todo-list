...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        //Aqui será setado as páginas e recursos em que o usuário sem sessão ativa poderá acessar.
        //No caso, será as routes de login e signup, responsáveis pelo login e registro.
        //Também é necessário colocar de alguns recursos da página login, por exemplo o arquivo CSS.
        ...
        boolean loggedIn = session != null && session.getAttribute("authUser") != null; //Especificamente essa boolean verifica se há sessão ativa e se houver, busca ela para liberar o acesso do usuário.
